...
class TeamHydrator 
{
    ...
    public static function getData() : array
    {
        ...
        $active_query = $pdo->prepare("
        SELECT teams.`id`, teams.`name`, teams.`photo`, teams.`team_color`, teams.`desc`, sports.`id`
        AS `sportId`, sports.`name` AS `sport`, countries.`name` AS `country`, countries.`id` AS countryId
        FROM `teams` 
